...
def create_app(accounts_file: str, api_key: str = "") -> web.Application:
    ...
    app.router.add_get("/admin/", admin_page)
    app.router.add_get("/admin/api/accounts", admin_get_accounts)
    app.router.add_put("/admin/api/accounts", admin_put_accounts)
    app.router.add_post("/admin/api/register/start", admin_register_start)
    app.router.add_get("/admin/api/register/log", admin_register_log)
    app.router.add_post("/admin/api/register/sync", admin_register_sync)
